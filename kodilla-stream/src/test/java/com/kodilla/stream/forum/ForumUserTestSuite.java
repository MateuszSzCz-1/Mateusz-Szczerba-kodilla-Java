...
public class ForumUserTestSuite {
    ...
    void testGetLocationsOfFriends() {
        ...
        assertEquals(4, user4.getLocationsOfFriends().size());
        assertTrue(user4.getLocationsOfFriends().contains("Washington"));
    }
    ...
    void testGetLocationsOfFriendsOfFriends() {
        ...
        assertTrue(user1.getLocationsOfFriendsOfFriends().contains("Orlando"));
